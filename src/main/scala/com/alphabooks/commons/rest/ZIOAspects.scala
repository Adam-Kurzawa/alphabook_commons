...
def errorHandler(): ZIOAspect[Nothing, Any, Nothing, Any, Response, Response] = new ZIOAspect[Nothing, Any, Nothing, Any, Response, Response]:
  override def apply[R >: Nothing <: Any, E >: Nothing <: Any, A >: Response <: Response](zio: ZIO[R, E, A])(using trace: Trace): ZIO[R, E, A] = zio
    .catchAll {
